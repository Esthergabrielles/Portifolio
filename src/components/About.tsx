...
const About: React.FC = () => {
  ...
  const defaultExperiences = [
    {
      icon: Award,
      title: 'QA Tester Júnior em Formação',
      description: 'Desenvolvendo expertise em testes manuais, automação e metodologias ágeis através de bootcamp intensivo',
    ...
    },
    {
      ...
      description: '2+ anos em processos organizacionais, auditorias documentais e melhoria contínua',
      gradient: 'from-emerald-500 to-green-500',
      delay: 0.2
    },
    {
      icon: Target,
      title: 'Transição de Carreira Estratégica',
      description: 'Combinando experiência administrativa com conhecimentos técnicos em QA para uma base sólida',
            ...
            >
              ...
              >
                <p className="text-2xl md:text-3xl text-slate-700 dark:text-slate-300 leading-relaxed font-inter">
                  {personalInfo?.description || 'Profissional em transição de carreira para QA, combinando 2+ anos de experiência em processos administrativos com conhecimentos técnicos em testes de software. Atualmente com 93% de progresso no bootcamp QA Engineer, demonstrando dedicação e aprendizado acelerado.'}
                </p>
              </PremiumCard>
            </motion.div>
          </AnimatedSection>
                  ...
                  >
                    <div className="relative overflow-hidden rounded-3xl">
                      <img
                        ...
                        alt={personalInfo?.name || "Esther Gabrielle - QA Tester em formação"}
                ...
                >
                  ...
                  >
                    <p className="text-xl text-slate-700 dark:text-slate-300 leading-relaxed mb-6 font-inter">
                      Profissional com sólida experiência em processos administrativos (2+ anos), atualmente em transição estratégica para a área de Quality Assurance. Reconhecida como Funcionária Destaque por excelência em auditorias documentais e melhoria de processos.
                    </p>
                    <p className="text-xl text-slate-700 dark:text-slate-300 leading-relaxed font-inter">
                      Atualmente com 93% de progresso no bootcamp QA Engineer da Mate Academy, combinando conhecimentos técnicos em testes com experiência prática em organização e atenção aos detalhes. Meu objetivo é aplicar essa base sólida para garantir a qualidade de software e contribuir para produtos excepcionais.
                    </p>
                  </PremiumCard>
                </motion.div>
              </AnimatedSection>
                  ...
                  >
                    <div className="flex flex-wrap gap-4">
                      {softSkills.length > 0 ? (
                        ...
                        ['Atenção aos Detalhes', 'Organização', 'Pensamento Analítico', 'Melhoria de Processos', 'Comunicação', 'Aprendizado Contínuo'].map((skill, index) => (
                          <motion.span
                            key={index}
                            className="px-6 py-3 bg-gradient-to-r from-primary-500 to-accent-500 text-white rounded-2xl font-semibold font-inter shadow-premium hover:shadow-glow hover:scale-105 transition-all duration-300 cursor-pointer"
                            initial={{ opacity: 0, scale: 0.8 }}
